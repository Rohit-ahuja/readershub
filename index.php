...
<head>
  <title>
ReadersHub — Share book recommendations with your friends, shop, review
</title>
...
<script>
  //<![CDATA[
    googletag.cmd.push(function() {
      googletag.pubads().setTargeting("sid", "4f21b82c8b44fd14669e1c04266b29e3");
    googletag.pubads().setTargeting("grsession", "4f21b82c8b44fd14669e1c04266b29e3");
...
<meta name="csrf-token" content="8P9nKkjTzkuK53Pt5+ssHqDEITc+IQwZXtjeyXSW/FpFbYNa8ptGPizXwbM7Aod/a7vk+n0351p0JwkZQc5ioQ==" />

  <meta name="request-id" content="D6DMQ6SHV9ZCJX3D09A5" />
...
<script src="https://s.gr-assets.com/assets/react_ujs-d9fd29be94e810d36e13f90d5c480c64.js"></script>
  ...
  //<![CDATA[
    if (typeof isShowingBuyableFeatures === 'undefined' || isShowingBuyableFeatures()) {
      googletag.cmd.push(function() {
        googletag.defineSlot('/4215/goodr.home.top.300x250', [300, 250], 'div-gpt-ad-ebc5fba358').addService(googletag.pubads()).setCollapseEmptyDiv(true);
    
        googletag.pubads().addEventListener('slotRenderEnded', function(event) {
          if (event.slot.getSlotId().getDomId() == "div-gpt-ad-ebc5fba358") {
            ...
            $gr.shared.dfpAd.attachTo("#div-gpt-ad-ebc5fba358", attrs);
    
            if (false && document.getElementById("div-gpt-ad-ebc5fba358").style.display != "none") {
...
<script>
  //<![CDATA[
    if (typeof isShowingBuyableFeatures === 'undefined' || isShowingBuyableFeatures()) {
      googletag.cmd.push(function() {
        googletag.defineSlot('/4215/goodr.home.cb.300x250', [300, 250], 'div-gpt-ad-29157decbe').addService(googletag.pubads()).setCollapseEmptyDiv(true);
    
        googletag.pubads().addEventListener('slotRenderEnded', function(event) {
          if (event.slot.getSlotId().getDomId() == "div-gpt-ad-29157decbe") {
            var attrs = $gr.shared.dfpAd.imageAdAttrs();
            attrs.dfpEvent = event;
            attrs.adDeviceType = "desktop";
            attrs.pmetImpressionTrackUrl = "https://www.goodreads.com/dfp/impression";
            attrs.pmetClickTrackUrl = "https://www.goodreads.com/dfp/click";
            $gr.shared.dfpAd.attachTo("#div-gpt-ad-29157decbe", attrs);
    
            if (false && document.getElementById("div-gpt-ad-29157decbe").style.display != "none") {
              var css = document.createElement("link");
              css.rel  = 'stylesheet';
              css.type = 'text/css';
              css.href = '/assets/ad_skins.css';
...
//<![CDATA[
  ...
  GoodreadsAnalytics.push(['_setCustomVar',
    ...
    'signed_in_facebook_connected',  // Custom variable value: signed_out, signed_in,
